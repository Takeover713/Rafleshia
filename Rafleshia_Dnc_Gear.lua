...
--Etoile Gorget +2, 41M on AH
    ...
    sets.engaged = {
		...
		body={ name="Adhemar Jacket", augments={'DEX+10','AGI+10','Accuracy+15',}}, --body="Horos Casaque +3", Relic
		hands={ name="Adhemar Wristbands", augments={'DEX+10','AGI+10','Accuracy+15',}},
		legs={ name="Samnuha Tights", augments={'STR+10','DEX+10','"Dbl.Atk."+3','"Triple Atk."+3',}},
		feet={ name="Herculean Boots", augments={'Attack+20','"Triple Atk."+3','Accuracy+14',}}, --"Horos T. Shoes +3", --Relic
		neck="Lissome Necklace", --Etoile Gorget +2, AH
		waist="Windbuffet Belt +1",
...
--• TP Cape (/WAR): DEX/Acc/DA This set is equipped in engaged ^
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {
		...
		waist="Fotia Belt",
		left_ear={ name="Moonshade Earring", augments={'Accuracy+4','TP Bonus +250',}},
		right_ear="Brutal Earring", --"Macu. Earring +2", --JSE Earring Sortie
		left_ring="Epaminondas's Ring",
		right_ring="Regal Ring",
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {
		ammo="Charis Feather", --Ironclad Executioner, Aby: Vunk
	    head={ name="Adhemar Bonnet +1", augments={'STR+12','DEX+12','Attack+20',}},
		body="Meg. Cuirie +1", -- Need to +2 ambu
		hands="Mummu Wrists +1", -- Need to +2 ambu
		legs={ name="Samnuha Tights", augments={'STR+10','DEX+10','"Dbl.Atk."+3','"Triple Atk."+3',}}, --"Lustr. Subligar +1", --Lust: Path B - Triton Abjuration: Legs
		feet={ name="Herculean Boots", augments={'Attack+20','"Triple Atk."+3','Accuracy+14',}}, --Herc: DEX/Att/Acc/CritDmg
		neck="Fotia Gorget",
		waist="Fotia Belt",
	...
	-- Weapons sets
	sets.weapons.Aeneas = {main="Gleti's Knife",sub={ name="Fusetto +2", augments={'TP Bonus +1000',}},}
	--??Taming Sari??
    ------------------------------
	  ------ Precast sets ------
	------------------------------

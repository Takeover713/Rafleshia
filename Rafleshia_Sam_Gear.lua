...
function user_setup()
    ...
    state.WeaponskillMode:options('Match','Normal','SomeAcc')
...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Wakido Kabuto +2",hands="Sakonji Kote +2",back=""}
	...
	sets.engaged = {
		...
		back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Damage taken-5%',}},
} --DEX +20, Acc +30, Atk +20, STP +10, PDT -10
	...
	sets.engaged.MEVA = {    
		...
		neck="Sam. Nodowa +2",
		waist="Sailfi Belt +1", --Sweordfaetels +1, AH
		left_ear="Dedition Earring",
		right_ear="Kasuga Earring +1",
		left_ring="Niqmaddu Ring",
		right_ring="Chirich Ring +1",
	...
	sets.precast.WS = { --Fudo
		ammo="Knobkierrie",
		head="Mpaca's Cap",
		body="Sakonji Domaru +3", -- +4
		hands="Kasuga Kote +3",
    ...
    right_ring="Defending Ring",
    back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Damage taken-5%',}},
} --'VIT+20','Eva.+20 /Mag. Eva.+20','DEF+50'
